...
$.extend($.easing, {
    ...
    (Riode.defaults = {
        ...
        minipopup: {
            ...
            template:
                '<div class="minipopup-box"><p class="minipopup-title">{{message}}</p><div class="product product-purchased {{productClass}} mb-0"><figure class="product-media"><a href="~/assets/~/assets/~/assets/{{imageLink}}"><img src="~/assets/~/assets/~/assets/{{imageSrc}}" alt="product" width="90" height="90"></a></figure><div class="product-detail"><a href="~/assets/~/assets/~/assets/{{nameLink}}" class="product-name">{{name}}</a>{{detailTemplate}}</div></div>{{actionTemplate}}</div>',
        },
        popup: {
            removalDelay: 350,
            callbacks: {
        ...
        templateCartAddedAlert:
            '<div class="alert alert-simple alert-btn cart-added-alert"><a href="~/assets/~/assets/~/assets/cart.html" class="btn btn-success btn-md">View Cart</a><span>"{{name}}" has been added to your cart.</span><button type="button" class="btn btn-link btn-close"><i class="d-icon-times"></i></button></div>',
        ...
        Riode.$body
            ...
            .on("click", ".link-to-tab", function (e) {
                ...
                e.preventDefault(),
                    ...
                    o.find('[href="~/assets/' + t + '"]').addClass("active"),
    ...
    (Riode.initPopups = function () {
        Riode.$body
                    ...
                    Riode.popup(
                        {
                            ...
                            callbacks: {
                                ajaxContentAdded: function () {
                                    this.wrap.find('[href="~/assets/#register"]').click();
                                },
                            },
                        },
                        "login"
            ...
            .on("click", ".btn-iframe", function (e) {
                e.preventDefault(), Riode.popup({ items: { src: '<video src="~/assets/~/assets/~/assets/' + $(e.currentTarget).attr("href") + '" autoplay loop controls>', type: "inline" }, mainClass: "mfp-video-popup" }, "video");
            }),
                ...
                (a.$wrapper = e),
                    ...
                    s
                        .on("initialized.owl.carousel", function (e) {
                            a.isQuickview || s.append('<a href="~/assets/~/assets/~/assets/#" class="product-image-full"><i class="d-icon-zoom"></i></a>'),
                                (function (e) {
                        ...
                        e.$wrapper.on("click", ".btn-cart", function (t) {
                            ...
                            (i.closest(".product-popup").length || document.body.classList.contains("home")) &&
                                Riode.Minipopup.open({
                                    ...
                                    actionTemplate:
                                        '<div class="action-group d-flex mt-3"><a href="~/assets/~/assets/~/assets/cart.html" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">View Cart</a><a href="~/assets/~/assets/~/assets/checkout.html" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>',
                                });
                        });
                    })(this);
            }),
                        ...
                        t.is(i.parent())
                            ...
                            : (i.parent().toggleClass("active"),
                                i.parent().hasClass("active")
                                    ? ($(".select-items").show(),
                                        $('<a href="~/assets/~/assets/~/assets/#" class="select-item">' + i.text() + '<i class="d-icon-times"></i></a>')
                ...
                .on("click", ".product:not(.product-variable) .btn-product-icon.btn-cart, .product:not(.product-variable) .btn-product.btn-cart", function (e) {
                    ...
                    t.hasClass("product-single") ||
                        Riode.Minipopup.open({
                            ...
                            actionTemplate:
                                '<div class="action-group d-flex"><a href="~/assets/~/assets/~/assets/cart.html" class="btn btn-sm btn-outline btn-primary btn-rounded">View Cart</a><a href="~/assets/~/assets/~/assets/checkout.html" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>',
                        });
                });
        },
